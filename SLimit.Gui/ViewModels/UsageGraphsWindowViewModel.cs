...
public partial class UsageGraphsWindowViewModel : ViewModelBase, IDisposable
{
    ...
    // private static SKTypeface _defaultGraphTypeface =  SKTypeface.FromStream(AssetLoader.Open(new Uri("avares://SLimit.Gui/Assets/Fonts/NotoSans/NotoSans-Light.ttf")));
    //     
